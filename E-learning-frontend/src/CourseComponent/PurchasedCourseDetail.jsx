...
const PurchasedCourseDetail = () => {
  ...
  useEffect(() => {
    const getCourse = async () => {
      try {
        const response = await axiosInstance.get(`/api/course/fetch/course-id?videoShow=Yes&courseId=${courseId}`);
  ...
  const downloadNotes = async () => {
    try {
      const response = await axiosInstance.get(
        `/api/course/notes/${course.notesFileName}/download`,
        {
          ...
          <div className="col-md-9 ms-5 mb-5">
            ...
            <div style={{ display: "flex", alignItems: "center" }}>
              <img
                ...
                className="card-img-top profile-photo mt-1 rounded-circle"
                alt="profile_pic"
              />
              <div className="ms-3">
                <Link
            ...
            <h2 className="mt-4">{course.name}</h2>
              ...
              {course.sections.map((section, sectionIndex) => (
                <div key={sectionIndex} className="rounded-3 mb-3">
                  ...
                  <button
                    ...
                    style={{
                      backgroundColor:
                        expandedSection === sectionIndex ? "#103e75" : "#f2e9e9ff",
                      borderColor:
                        expandedSection === sectionIndex
                          ? "#103e75"
                          : "#dee2e6",
            ...
            <input
              type="submit"
              className="btn btn-outline-dark text-color mt-2 mb-5"
