...
const ViewMentorCourses = () => {
  ...
  const retrieveAllCourse = async () => {
    const response = await axiosInstance.get("/api/course/fetch/mentor-wise?status=Active&videoShow=Yes&mentorId=" + mentor.id);
      ...
      >
        ...
        >
          <div className="table-responsive">
            ...
            table-striped text-color text-center">
                    ...
                    <tr>
                      ...
                      <td>
                        <button
                          ...
                          className="btn btn-sm btn-warning custom-bg-text ms-2 mb-2"
                        >
                          Update
                        </button>
