...
const MentorAllCoursesPage = () => {
  ...
  const retrieveallCourse = async () => {
    const response = await axiosInstance.get("/api/course/fetch/mentor-wise?status=Active&videoShow=No&mentorId=" + mentorId
    );
    return response.data;
  };

  const retrieveUser = async () => {
    const response = await axiosInstance.get("/api/user/fetch/user-id?userId=" + mentorId);
    return response.data;
  };
