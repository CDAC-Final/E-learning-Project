...
const CourseDetailPage = () => {
  ...
  const retrieveCourse = async () => {
    ...
    const response = await axiosInstance.get(
      "/api/course/fetch/course-user-id?courseId=" +courseId + "&userId=" + customerId
    );
              ...
              {course.sections.map((section, index) => (
                <div key={index} className="rounded-3 mb-3">
                  ...
                  <button
                    ...
                    style={{
                      backgroundColor:
                        expandedSection === index ? "#103e75" : "#fff",
                      borderColor:
                        expandedSection === index ? "#103e75" : "#f2e9e9ff",
                  ...
                  if (course.type === "Free") {
                    ...
                    if (isCoursePurchased === "Yes") {
                      ...
                      return (
                        <button
                          type="submit"
                          class="btn btn-warning text-color mt-3"
