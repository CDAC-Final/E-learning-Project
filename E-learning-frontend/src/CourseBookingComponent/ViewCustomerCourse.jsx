...
const ViewCustomerCourse = () => {
  ...
  const retrieveAllBooking = async () => {
    const response = await axiosInstance.get("/api/course/booking/fetch/customer-wise?customerId=" + customer.id);
  ...
  return (
    <div className="mt-3">
      ...
      >
        <div
          className="card-header custom-bg-text text-center text-white"
          style={{
            borderRadius: "10px",
            height: "50px",
            margin:"10px 17px",
        ...
        >
          <div className="table-responsive">
            <table className="table table-hover table-striped text-color text-center">
                    ...
                    <tr>
                      ...
                      <td>
                        <button
                          ...
                          className="btn btn-sm btn-outline-warning custom-bg-text ms-2"
                        >
                          Start Course
                        </button>
                      </td>
