    ...
    <ul class="navbar-nav ms-auto mb-2 mb-lg-0 me-5">
      <li class="nav-item">
        <Link
          ...
          aria-current="page"
        >
          <b className="text-color btn btn-outline-dark">Dashboard</b>
        </Link>
      </li>
      <li class="nav-item dropdown">
        <a
          ...
          aria-expanded="false"
        >
          <b className="text-color btn btn-outline-dark"> My Course</b>
        </a>
        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
          <li>
            <Link
              ...
              aria-current="page"
            >
              <b className="text-color btn btn-outline-primary">Add Course</b>
            </Link>
          </li>
          <li>
            <Link
              ...
              aria-current="page"
            >
              <b className="text-color btn btn-outline-primary">View Course</b>
            </Link>
          </li>
        </ul>
      </li>
      ...
      <li class="nav-item">
        <Link to="/mentor/profile" class="nav-link active" aria-current="page">
          <b className="text-color btn btn-outline-dark">Profile</b>
        </Link>
      </li>
      <li class="nav-item">
        <Link
